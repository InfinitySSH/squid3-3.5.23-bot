...
Http::StatusCodeString(const Http::StatusCode status)
{
    ...
    case Http::scOkay:
        return "<font color='#9933FF'>Proxy Conectado <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    case Http::scCreated:
        return "Criado";
        break;
	...
	case Http::scMovedPermanently:
        return "<font color='blue'>Movido Permanentemente <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;

    case Http::scFound:
        return "<font color='blue'>Encontrado <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    ...
    case Http::scUseProxy:
        return "<font color='red'>Proxy Detectado <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    ...
    case Http::scForbidden:
        return "<font color='red'>Conexão ao servidor SSH recusada <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    ...
    case Http::scProxyAuthenticationRequired:
        return "<font color='red'>O Proxy requer autenticação <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    ...
    case Http::scInternalServerError:
        return "<font color='red'>Erro Interno no Servidor <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;

    case Http::scNotImplemented:
        return "<font color='red'>Nâo Disponível <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;

    case Http::scBadGateway:
        return "<font color='red'>Erro na Gateway <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;

    case Http::scServiceUnavailable:
        return "<font color='red'>Serviço Indisponível <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;

    case Http::scGatewayTimeout:
        return "<font color='red'>Gateway Offline <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;

    case Http::scHttpVersionNotSupported:
        return "<font color='orange'>Versão HTTP não suportada <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    ...
    case Http::scInsufficientStorage:
        return "<font color='red'>Armazenamento Cheio <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    ...
    case Http::scNetworkAuthenticationRequired:
        return "<font color='blue'>A Rede requer Autenticação <a href='//t.me/InfinitySSHSmartBot'>@InfinitySSHSmartBot</a></font>";
        break;
    // 600+
